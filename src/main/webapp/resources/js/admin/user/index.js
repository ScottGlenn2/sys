				...
				rend2Table:function(result){
					...
					$.each(result,function(ind,da){
						...
						if(da.checked == true) {
							...
							str +="<tr><td><label><input type=\"checkbox\" name=\"roleState\" value=\""+da.roleId+"\" class=\"i-checks\" checked> </label></td><td>"+da.roleName+"</td><td>"+stateStr+"</td><td>"+da.createTime+"</td><td>"+da.updateTime+"</td></tr>";
						} else {
							
							str +="<tr><td><label><input type=\"checkbox\" name=\"roleState\" value=\""+da.roleId+"\" class=\"i-checks\"> </label></td><td>"+da.roleName+"</td><td>"+stateStr+"</td><td>"+da.createTime+"</td><td>"+da.updateTime+"</td></tr>";
						}
					});
					str +="</table>";
