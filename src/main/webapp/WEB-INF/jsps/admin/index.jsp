...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  <title>后台管理系统</title>
    ...
    <meta name="keywords" content="冬天后台管理，冬天后台管理">
    <meta name="description" content="冬天后台管理，冬天">
...
<body class="fixed-sidebar full-height-layout gray-bg">
    ...
    <sec:authenticated>
                ...
                <ul class="nav" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            <span><img alt="image" class="img-circle" src="<c:url value='/resources/hplus/img/profile_small.jpg'/>" /></span>
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="clear">
                               <span class="block m-t-xs"><strong class="font-bold"><sec:principal property="nickName"/></strong></span>
                                <span class="text-muted text-xs block"><sec:principal property="nickName"/><b class="caret"></b></span>
                                </span>
                            </a>
                        ...
                        <div class="logo-element">Sys
                        </div>
                    </li>
                    <c:forEach items="${menuList }" var="topMenu">
                      <li>
                        <a href="#">
                            <i class="fa ${topMenu.icon }"></i>
                        ...
                        <c:forEach items="${topMenu.childMenuList }" var="childMenu">
                            ...
                            <li>
                                <a class="J_menuItem" href="${childMenu.menuUrl }" data-index="0"><i class="fa fa-users ${childMenu.icon }"></i>${childMenu.menuName}</a>
                            </li>
                             </c:forEach>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                            <a  class ="J_menuItem" href="" data-index="0"><i class="fa fa-users"></i> 用户管理</a>
                          
                            </li>
                            <li>
                                <a class="J_menuItem" href="<c:url value='/admin/role/index.do'/>">评论管理</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="<c:url value='/admin/resource/index.do'/>">网络爬虫</a>
                            </li>
                        </ul>
                    </li>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            <div class="row border-bottom">
                <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                    ...
                    <ul class="nav navbar-top-links navbar-right">
                        ...
                        <li>
                            <a href="index_v1.html" class="J_menuItem" data-index="0"><i class="fa fa-cart-arrow-down"></i> 注销</a>
                        </li>
                        <li class="dropdown">
            ...
            <div class="row content-tabs">
                ...
                <nav class="page-tabs J_menuTabs">
                    <div class="page-tabs-content">
                        <a href="javascript:;" class="active J_menuTab" data-id="<c:url value='/home.jsp'/>">首页</a>
                    </div>
                </nav>
            ...
            <div class="row J_mainContent" id="content-main">
                <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="<c:url value='/home.jsp'/>" frameborder="0" data-id="<c:url value='/home.jsp'/>" seamless></iframe>
            </div>
            <div class="footer">
                <div class="pull-right">&copy; 2014-2015 <a href="/" target="_blank">dongtian's blog</a>
                </div>
            </div>
        </div>
        <!--右侧部分结束-->
    ...
    <script src="<c:url value='/resources/hplus/js/plugins/metisMenu/jquery.metisMenu.js'/>"></script>
    <script src="<c:url value='/resources/hplus/js/plugins/slimscroll/jquery.slimscroll.min.js'/>"></script>
    <script src="<c:url value='/resources/hplus/js/plugins/layer/layer.min.js'/>"></script>

    <!-- 自定义js -->
    <script src="<c:url value='/resources/hplus/js/hplus.min.js'/>"></script>
    <script type="text/javascript" src="<c:url value='/resources/hplus/js/contabs.min.js'/>"></script>

    <!-- 第三方插件 -->
    <script src="<c:url value='/resources/hplus/js/plugins/pace/pace.min.js'/>"></script>
