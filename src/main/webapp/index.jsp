                ...
                <ul class="nav" id="side-menu">
                        ...
                        <div class="dropdown profile-element">
                            ...
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                               ...
                               <span class="block m-t-xs"><strong class="font-bold">超级管理员</strong></span>
                                <span class="text-muted text-xs block">冬天<b class="caret"></b></span>
                                </span>
                            </a>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="<c:url value='/admin/user/index.do'/>" data-index="0"><i class="fa fa-users"></i>用户管理</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="<c:url value='/admin/role/index.do'/>"><i class="fa fa-user-plus"></i>角色管理</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="<c:url value='/admin/resource/index.do'/>"><i class="fa fa-user-secret"></i>权限资源管理</a>
                            </li>
                        </ul>
                    </li>
